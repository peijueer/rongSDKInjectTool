...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v3}, Lcom/unionpay/mobile/android/upwidget/w;->setOrientation(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/unionpay/mobile/android/upwidget/x;->a(Ljava/lang/CharSequence;)V

    const v0, -0xcf8b55

    const v1, -0xf2c28f

    invoke-static {v0, v1}, Lcom/unionpay/mobile/android/utils/h;->a(II)Landroid/content/res/ColorStateList;

    move-result-object v0

    iget-object v1, p0, Lcom/unionpay/mobile/android/upwidget/w;->b:Lcom/unionpay/mobile/android/upwidget/x;

    invoke-virtual {v1, v0}, Lcom/unionpay/mobile/android/upwidget/x;->a(Landroid/content/res/ColorStateList;)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/upwidget/w;->b:Lcom/unionpay/mobile/android/upwidget/x;

    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/upwidget/w;->addView(Landroid/view/View;)V
...
.method public static final a(Landroid/content/Context;Lorg/json/JSONObject;Landroid/graphics/drawable/Drawable;)Lcom/unionpay/mobile/android/upwidget/w;
    ...
    new-instance v0, Lcom/unionpay/mobile/android/upwidget/w;

    invoke-direct {v0, p0, v1, v2, p2}, Lcom/unionpay/mobile/android/upwidget/w;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
