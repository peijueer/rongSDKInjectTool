...
.method private constructor <init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/upwidget/x;->setOrientation(I)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/upwidget/x;->a:Landroid/content/Context;
    ...
    :cond_1
    iget-object v1, p0, Lcom/unionpay/mobile/android/upwidget/x;->b:Landroid/widget/TextView;

    invoke-virtual {p0, v1, v0}, Lcom/unionpay/mobile/android/upwidget/x;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public static a(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Lcom/unionpay/mobile/android/upwidget/x;
    ...
    iget-object v1, v0, Lcom/unionpay/mobile/android/upwidget/x;->b:Landroid/widget/TextView;
    ...
    invoke-static {v1, v2}, Lcom/unionpay/mobile/android/utils/h;->a(II)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/unionpay/mobile/android/upwidget/x;->a(Landroid/content/res/ColorStateList;)V
