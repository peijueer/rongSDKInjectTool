...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->a:Landroid/content/Context;

    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->b:Landroid/widget/EditText;

    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->c:Landroid/widget/ImageView;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/unionpay/mobile/android/widgets/u;->d:Z

    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->e:Lcom/unionpay/mobile/android/widgets/u$b;

    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->f:Lcom/unionpay/mobile/android/widgets/u$a;

    iput-object v7, p0, Lcom/unionpay/mobile/android/widgets/u;->i:Landroid/widget/TextView;

    new-instance v0, Lcom/unionpay/mobile/android/widgets/v;

    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/widgets/v;-><init>(Lcom/unionpay/mobile/android/widgets/u;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/widgets/u;->k:Landroid/view/View$OnClickListener;

    new-instance v0, Lcom/unionpay/mobile/android/widgets/w;

    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/widgets/w;-><init>(Lcom/unionpay/mobile/android/widgets/u;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/widgets/u;->l:Landroid/text/TextWatcher;

    new-instance v0, Lcom/unionpay/mobile/android/widgets/x;

    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/widgets/x;-><init>(Lcom/unionpay/mobile/android/widgets/u;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/widgets/u;->m:Landroid/view/View$OnFocusChangeListener;

    iput-object p1, p0, Lcom/unionpay/mobile/android/widgets/u;->a:Landroid/content/Context;

    invoke-virtual {p0, v6}, Lcom/unionpay/mobile/android/widgets/u;->setOrientation(I)V

    sget v0, Lcom/unionpay/mobile/android/global/a;->n:I

    iput v0, p0, Lcom/unionpay/mobile/android/widgets/u;->g:I

    new-instance v0, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v0, v5, v5}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/widgets/u;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/widgets/u;->setFocusable(Z)V
    ...
    invoke-static {v1, v8}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I
    ...
    invoke-virtual {p0, v0, v1}, Lcom/unionpay/mobile/android/widgets/u;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/unionpay/mobile/android/widgets/u;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/widgets/u;->a:Landroid/content/Context;

    invoke-static {v3, v8}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I
    ...
    iput-object v1, p0, Lcom/unionpay/mobile/android/widgets/u;->j:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/u;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/u;->c:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/u;->k:Landroid/view/View$OnClickListener;
...
.method static synthetic e(Lcom/unionpay/mobile/android/widgets/u;)Lcom/unionpay/mobile/android/widgets/u$a;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/u;->f:Lcom/unionpay/mobile/android/widgets/u$a;
...
.method public final a()V
    ...
    iput-boolean v2, p0, Lcom/unionpay/mobile/android/widgets/u;->d:Z
