...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/graphics/drawable/Drawable;ILcom/unionpay/mobile/android/widgets/ay$a;)V
    ...
    iput v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->h:I

    iput v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->i:I

    iput v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->j:I
...
.method static synthetic a(Lcom/unionpay/mobile/android/widgets/ay;)Lcom/unionpay/mobile/android/widgets/ay$a;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->k:Lcom/unionpay/mobile/android/widgets/ay$a;
...
.method private b(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->a:Landroid/content/Context;

    invoke-direct {v0, v2}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->g:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->g:Landroid/widget/LinearLayout;

    new-instance v2, Lcom/unionpay/mobile/android/widgets/az;

    invoke-direct {v2, p0}, Lcom/unionpay/mobile/android/widgets/az;-><init>(Lcom/unionpay/mobile/android/widgets/ay;)V

    invoke-virtual {v0, v2}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->g:Landroid/widget/LinearLayout;

    iget v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->j:I

    iget v3, p0, Lcom/unionpay/mobile/android/widgets/ay;->j:I

    iget v4, p0, Lcom/unionpay/mobile/android/widgets/ay;->j:I

    iget v5, p0, Lcom/unionpay/mobile/android/widgets/ay;->j:I
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->g:Landroid/widget/LinearLayout;

    invoke-virtual {p0, v2, v0}, Lcom/unionpay/mobile/android/widgets/ay;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->a:Landroid/content/Context;

    invoke-static {v0, v10}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I
    ...
    iget v3, p0, Lcom/unionpay/mobile/android/widgets/ay;->h:I

    if-eqz v3, :cond_0

    iget v0, p0, Lcom/unionpay/mobile/android/widgets/ay;->h:I

    :cond_0
    new-instance v3, Landroid/widget/ImageView;

    iget-object v4, p0, Lcom/unionpay/mobile/android/widgets/ay;->a:Landroid/content/Context;

    invoke-direct {v3, v4}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iget-object v4, p0, Lcom/unionpay/mobile/android/widgets/ay;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget v3, p0, Lcom/unionpay/mobile/android/widgets/ay;->i:I
    ...
    iput-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->d:Landroid/widget/TextView;

    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->d:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/unionpay/mobile/android/widgets/ay;->b:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v3, v2}, Lcom/unionpay/mobile/android/widgets/ay;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v0, v4}, Lcom/unionpay/mobile/android/widgets/ay;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->f:Landroid/widget/ImageView;

    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/ay;->f:Landroid/widget/ImageView;

    invoke-virtual {v2, v1}, Landroid/widget/ImageView;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->f:Landroid/widget/ImageView;

    invoke-virtual {p0, v1, v0}, Lcom/unionpay/mobile/android/widgets/ay;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->c:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/ay;->c:Landroid/widget/ImageView;
